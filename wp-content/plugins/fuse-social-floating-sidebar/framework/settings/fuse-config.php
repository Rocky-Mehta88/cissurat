...
$args['footer_text'] = __('
    ...
    <div class="flash_sale_sm"><span class="flashit">SUMMER SALE</span> Get 20% OFF Right Now! Use coupon code <strong class="sale_off">SALE20OFF</strong> <a href="'.fs_fs()->get_upgrade_url().'">Upgrade Now!</a> </div>', 'redux-framework-demo' );
