...
<div class="wrap">
	...
	<h2><?php _e( 'Ticker Ultimate', 'ticker-ultimate' ); ?></h2><br />
				...
				<table class="wpos-plugin-pricing-table">
					...
					<thead>
						<tr>
							...
							<th>
								...
								<a href="<?php echo WPTU_SITE_LINK; ?>/wordpress-plugin/ticker-ultimate/?utm_source=WP&utm_medium=PostTicker&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
							</th>	    		
						</tr>
					</thead>
					...
					<tfoot>
						<tr>
							...
							<a href="<?php echo WPTU_SITE_LINK; ?>/wordpress-plugin/ticker-ultimate/?utm_source=WP&utm_medium=PostTicker&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
