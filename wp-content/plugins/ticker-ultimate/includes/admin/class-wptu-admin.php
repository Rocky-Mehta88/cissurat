...
class Wptu_Admin {
	...
	function wptu_register_menu() {
		...
		add_submenu_page( 'edit.php?post_type='.WPTU_POST_TYPE, __('Upgrade To Premium  - Ticker Ultimate', 'ticker-ultimate'), '<span style="color:#ff2700">'.__('Upgrade To Premium ', 'ticker-ultimate').'</span>', 'manage_options', 'wptu-premium', array($this, 'wptu_premium_page') );
	}
