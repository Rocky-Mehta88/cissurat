...
if( ! defined( 'WPTU_VERSION' ) ) {
	define( 'WPTU_VERSION', '1.5.4' ); // Version of plugin
}
if( ! defined( 'WPTU_NAME' ) ) {
	define( 'WPTU_NAME', 'Post Ticker Ultimate' ); // Name of plugin
}
...
if( ! defined( 'WPTU_PLUGIN_LINK' ) ) {
	define( 'WPTU_PLUGIN_LINK', 'https://www.essentialplugin.com/wordpress-plugin/ticker-ultimate/?utm_source=WP&utm_medium=PostTicker&utm_campaign=Features-PRO' ); // Plugin metabox prefix
}
