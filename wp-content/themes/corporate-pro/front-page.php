...
function corporate_front_page_loop() {
	...
	genesis_widget_area( 'front-page-6', array(
		'before' => '<div id="front-page-6" class="front-page-widget front-page-6"><div class="wrap-wrap">',
		'after'  => '</div></div>',

	) );

	genesis_widget_area( 'front-page-7', array(
		'before' => '<div id="front-page-7" class="front-page-widget front-page-7"><div id="contact-details" class="wrap">',
		'after'  => '</div></div>',
